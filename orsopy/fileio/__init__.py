...
All public classes and functions in the :py:mod:`fileio` module are available directly from
:py:mod:`fileio` without needing to specify a particular submodule.

The ORSO file format specification is available
`here <https://www.reflectometry.org/advanced_and_expert_level/file_format>`_.
"""
